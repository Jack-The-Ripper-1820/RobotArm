...
//			int matches = fscanf(file, "%d/%d/%d %d/%d/%d %d/%d/%d\n", &vertexIndex[0], &normalIndex[0], &textureIndex[0], &vertexIndex[1],&normalIndex[1], 
//				&textureIndex[1], &vertexIndex[2], &normalIndex[2], &textureIndex[2]);
//			if (matches != 9){
...
//	}
//
//	std::cout << "vertex indices normal indices done" << std::endl;
//
//
...
//	}
//
//	std::cout << "assigning done" << std::endl;
//
//	return true;
//}
